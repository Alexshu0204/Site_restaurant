...
export class MenuItemsService {
  ...
  private async createMenuItem(createMenuItemDto: CreateMenuItemDto) {
    ...
    const menuItem = this.menuItemsRepository.create({
      ...
      price: createMenuItemDto.price ?? null,
      priceGourmand: createMenuItemDto.priceGourmand ?? null,
      priceTresGourmand: createMenuItemDto.priceTresGourmand ?? null,
  ...
  private async updateMenuItem(
    ...
    if (updateMenuItemDto.priceGourmand !== undefined) {
      item.priceGourmand = updateMenuItemDto.priceGourmand;
    }
    if (updateMenuItemDto.priceTresGourmand !== undefined) {
      item.priceTresGourmand = updateMenuItemDto.priceTresGourmand;
    }
