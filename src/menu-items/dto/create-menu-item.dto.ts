...
export class CreateMenuItemDto {
  ...
  @ApiPropertyOptional({
    example: 950,
    description:
      'Prix en centimes (950 = 9.50 EUR). Null si seul le format gourmand existe.',
    minimum: 0,
    nullable: true,
  })
  @IsInt()
  ...
  @ApiPropertyOptional({
    example: 1450,
    description:
      "Prix format gourmand en centimes. Null si le plat n'a pas de format gourmand.",
    minimum: 0,
    nullable: true,
  })
  @IsInt()
  ...
  @ApiPropertyOptional({
    example: 1950,
    description:
      'Prix 3e format en centimes. Null si le plat ne propose pas de 3e quantite.',
    minimum: 0,
    nullable: true,
  })
  @IsInt()
