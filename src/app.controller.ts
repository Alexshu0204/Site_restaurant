    ...
    <main class="card">
      ...
      <form id="reset-form">
        ...
        <input
          ...
          oninvalid="this.setCustomValidity('Le mot de passe doit contenir au moins 12 caractères, une majuscule, une minuscule, un chiffre et un caractère spécial.')"
    ...
    <script>
      ...
      form.addEventListener('submit', async (event) => {
        ...
        try {
          ...
          message.textContent = payload.message || 'Mot de passe réinitialisé avec succès.';
          form.reset();
        } catch (error) {
          message.className = 'err';
